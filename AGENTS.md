...
- Docs and assets: `docs/`; shared configs: `biome.json`, `tsconfig*.json`, `phantom.config.json`; builds land in package-level `dist/`.
...
- Biome enforces 2-space indentation, double quotes, organized imports, and no unused variables.
